...
# Estrategia Financiera: La Firma Bajo Información, Riesgo y Capacidad.
</section>
  ...
  <div class="smart-funnel" aria-label="Premisa: analista evaluando un pitch de inversión">
    <div class="funnel">
      ...
      <div class="band band-3 fragment" data-fragment-index="0">
        <span>Son analistas en una firma de inversión especializada en startups.</span>
      </div>
    ...
    <div class="fork">
      <div class="lane lane-good">
        <div class="lane-track">
          <div class="pill">Fundador: 2 exits previos — $80M y $850M</div>
          <div class="pill">$41M levantados antes del primer usuario</div>
          <div class="pill">Google ofreció $200M pre-lanzamiento — dijeron que no</div>
      ...
      <div class="lane lane-bad">
        <div class="lane-track">
          ...
          <div class="badge-loss" role="note" aria-label="0.4 por ciento de los deals concentra mas de la mitad del retorno">
            <strong>0.4%</strong><span> de los deals →<br>+50% del retorno total</span>
          </div>
...
<p style="text-align:center; color:#5b6573; font-size:1.15em; max-width:820px; margin:0 auto 0.8em;">
El comité quiere su recomendación. Elijan una de las tres alternativas:
</p>

<style>
  #decision-cards{ --ink:#5b6573; }
  #decision-cards .row{ display:flex; gap:clamp(10px,1.8vw,18px); align-items:stretch;
    justify-content:center; max-width:1080px; margin:0 auto; flex-wrap:wrap; }
  #decision-cards .card{ position:relative; flex:1 1 0; min-width:230px;
    background:linear-gradient(180deg,#fff,var(--wash,#fbfdff)); border:1px solid #e6eaef;
    border-radius:14px; padding:20px 18px 18px; box-shadow:0 6px 18px rgba(0,0,0,.06); }
  #decision-cards .card .badge{ position:absolute; top:-16px; left:-16px; width:40px; height:40px;
    border-radius:999px; background:var(--c,#0d5e3a); color:#fff; display:grid; place-items:center;
    font-weight:800; font-size:17px; box-shadow:0 6px 14px rgba(0,0,0,.18); }
  #decision-cards .card p{ margin:.2em 0 0; color:var(--ink); font-size:clamp(14px,1.5vw,16px);
    line-height:1.4; font-weight:600; }
  #decision-cards .card::after{ content:""; position:absolute; left:0; right:0; bottom:0; height:5px;
    border-radius:0 0 14px 14px; background:var(--c,#0d5e3a); }
  #decision-cards .card.opt-a{ --c:#b06a06; }
  #decision-cards .card.opt-b{ --c:#b0234a; }
  #decision-cards .card.opt-c{ --c:#8a8f98; }
  @media (max-width:900px){ #decision-cards .row{ flex-direction:column; } }
</style>

<div id="decision-cards">
  <div class="row">
    <div class="card opt-a">
      <div class="badge">A</div>
      <p>Sí, inviertan — la tendencia es clara.</p>
    </div>
    <div class="card opt-b">
      <div class="badge">B</div>
      <p>No inviertan — la muestra es muy corta y volátil.</p>
    </div>
    <div class="card opt-c">
      <div class="badge">C</div>
      <p>Prefiero lanzar una moneda.</p>
    </div>
  </div>
</div>
