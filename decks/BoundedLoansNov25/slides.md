...
$$\begin{aligned}
U_t &= w(p_t)\,(c_t^{\mathrm{repay}}-r_t)_{+}^{\alpha_v} - \lambda\,(r_t-c_t^{\mathrm{repay}})_{+}^{\beta_v} + (1{-}w(p_t))\,(c_t^{\mathrm{default}}-r_t)_{+}^{\alpha_v} - \lambda\,(r_t-c_t^{\mathrm{default}})_{+}^{\beta_v} \\[4pt]
